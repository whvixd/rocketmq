...
public class RouteInfoManager {
    ...
    private final HashMap<String/* topic */, List<QueueData>> topicQueueTable; // topic数据信息
    private final HashMap<String/* brokerName */, BrokerData> brokerAddrTable; // broker数据信息
    private final HashMap<String/* clusterName */, Set<String/* brokerName */>> clusterAddrTable; // broker机器名称对应broker名称（见broker.conf）
